<template>
	<div class="chapters">
		<div v-if="dlStatus" class="loader-box fixed inset-0">
			...
			<div class="absolute top-2/3 left-1/2 -translate-x-1/2 transform text-2xl font-semibold">
				{{ dlStatus }}
			</div>
		</div>
				...
				<svg width="17px" height="17px" viewBox="0 0 100 100">
					<g fill="#F9A8D4">
						<g transform="translate(2.000000, 2.000000)">
							<path
								d="M48,96 C74.509668,96 96,74.509668 96,48 C96,21.490332 74.509668,0 48,0 C21.490332,0 0,21.490332 0,48 C0,74.509668 21.490332,96 48,96 Z"></path>
						</g>
					</g>
				</svg>
			</div>
